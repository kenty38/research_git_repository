...
void set_value(struct Node nn[ONE_SIDE][ONE_SIDE]){
	...
	while(fgets(line,STRING_MAX,fp2) !=NULL){
		...
		sscanf(line,"%[^,],%d,%d,%d,%d,%f",
				...
				&nn[i/ONE_SIDE][i%ONE_SIDE].population,&nn[i/ONE_SIDE][i%ONE_SIDE].space,&nn[i/ONE_SIDE][i%ONE_SIDE].popu_dens);
				...
				//printf("%s %d %d %d %d %.1f",nn[i/ONE_SIDE][i%ONE_SIDE].name,nn[i/ONE_SIDE][i%ONE_SIDE].x,nn[i/ONE_SIDE][i%ONE_SIDE].y,nn[i/ONE_SIDE][i%ONE_SIDE].population,nn[i/ONE_SIDE][i%ONE_SIDE].space,nn[i/ONE_SIDE][i%ONE_SIDE].popu_dens);
