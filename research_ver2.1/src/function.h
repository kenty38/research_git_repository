...
#define INFECTED_PROBABIRITY		0.1
#define REMEDY_PROBABIRITY      0.20
...
typedef struct Node{
		...
		int   accepting_count;		 //隣人の数に応じて変わる、情報を流すかどうか悩む回数
}t_Node;
...
extern void set_edge_BA(struct Node[][ONE_SIDE],struct Edge[]);
