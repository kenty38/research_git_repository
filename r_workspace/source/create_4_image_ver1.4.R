...
#filename
before_workspace <- "/home/ax909424/git_laptop/research_git_repository/r_workspace"
...
#------create total data matrix( 10000 colums * 220 rows)-----------------
  ...
  for(i in 1:2){
      lty_count <- 5
      png(paste("/home/ax909424/r/image",expand[kind_of_expand],"/",inc_hei[i],".png",sep=""),width=800,height=600)
