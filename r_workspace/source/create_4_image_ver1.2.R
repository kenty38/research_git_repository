...
date             <- c("/20181106","/20181106","/20181106","/20181106")
...
#------create total data matrix( 10000 colums * 220 rows)-----------------
  ...
  for(i in 1:2){
      ...
      par(mgp=c(4,1.2,0))
      plot(0,0,type="n",xlim=range(0,10),ylim=range(0,20),xlab="theta",ylab=inc_hei[i],main=main_thema[i] , xaxt = "n" , yaxt = "n" ,cex.lab = 2.5 , cex.main = 2.5)
